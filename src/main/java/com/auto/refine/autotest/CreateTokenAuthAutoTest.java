...
public class CreateTokenAuthAutoTest {
    ...
    public void createTokenSaleTest(){
        ...
        CreateTokenSaleRequestData requestData= new CreateTokenSaleRequestData();
        ...
        TreeMap<String,String> param=paramsInput.Param("data/createTokenSaleParams.xlsx");
        ...
        try {
            requestStr=requestData.createTokenSaleRequestStr();
        ...
        Assert.assertEquals("create_token_sale",transType);
